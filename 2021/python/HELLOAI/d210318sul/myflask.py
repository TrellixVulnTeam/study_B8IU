...
import cx_Oracle
import json
from d210318sul.mydao_suser import MyDaoSuser
from d210318sul.mydao_survey import MyDaoSurvey
from d210318sul.mydao_sdetail import MyDaoSdetail
from d210318sul.mydao_starget import MyDaoStarget
from d210318sul.mydao_sresult import MyDaoSresult
from d210318sul.mymail import MyMail
from d210318sul.mysms import MyMessage
...
# 
#     return render_template('sresult.html', sresults=sresult, survey_id=survey_id)
...
def sresult():
    ...
    if "user_id" not in session:
        return redirect('/login.html')
    sresult = MyDaoSresult().mySelectChart(survey_id)
    survey_title = MyDaoSurvey().myselectsurvey(survey_id)

    return render_template('../d210308/templates/sresult.html', sresults=sresult, survey_title=survey_title)
