...
from d210304survey.mydao_sdetail import MySdetailDao
from d210304survey.mydao_suser import MySuserDao
from d210304survey.mydao_survey import MySurveyDao
...
def loginajax():
    ...
    if MySuserDao().myLogin(user_id, pwd):
